    ...
    <body>
        ...
        <nav class="nav-extended grey darken-3 z-depth-2">
            <div class="nav-wrapper grey darken-3">
                <a href="#" class="brand-logo"><small>vStats for SMS</small></a>
            </div>
        ...
        <div id="about" class="col s12">
            <div class="container">
                ...
                <br /><br />
                <h5>About</h5>
                <p>vStats for SMS is meant to bring you an easy to view and deep analysis of statistics based on how you type, how people respond to you, and much more. Stay tuned for additional details!</p>
            </div>
        </div>
        ...
        <div id="pr" class="col s12">
            <div class="container">
                <h5><i class="material-icons left vblue-text">build</i> There are no public releases, but we are working on it!</h5>
                 <p>Hang tight for the time being, but rest assured, we are working on getting the first public release ready for use.<br /><!-- Want to watch or contribute to our progress? Check out the <a href="//github.com/v0lture/project-solo-sombreros" class="vblue-text">GitHub repository</a>.--></p> 
            </div>
        </div>
