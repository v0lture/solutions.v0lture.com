    ...
    <body>
        ...
        <nav class="nav-extended grey darken-3 z-depth-2">
            <div class="nav-wrapper grey darken-3">
                <a href="#" class="brand-logo"><small>Project Mike</small></a>
            </div>
        ...
        <div id="about" class="col s12">
            <div class="container">
                ...
                <p class="thin"><i class="material-icons left">devices_other</i> This project is available for <b>web</b> and <b>Android</b>.</p>
                ...
                <br /><br />
                <h5>About</h5>
                <p>Project Mike is a chat app that aspires to be unique in the terms of the various links, apps, and much more that it supports while still having a clean and simple chatting experience across mobile and desktop.</p>
            </div>
        </div>
